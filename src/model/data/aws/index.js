...
function writeFragment(fragment) {
  ...
  try {
    logger.info({ params, fragment }, 'Success writing fragment to DynamoDB');
...
async function readFragment(ownerId, id) {
  ...
  try {
    ...
    logger.info({ params, data }, 'Success reading fragment from DynamoDB');
...
async function listFragments(ownerId, expand = false) {
  ...
  try {
    ...
    logger.info({
      ...
      params,
      data,
    }, 'Getting all fragments for user from DynamoDB');
